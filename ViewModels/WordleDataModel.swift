...
class WordleDataModel: ObservableObject {
    ...
    var coorectlyPlacedLetters = [String]()
    var selectedWord = ""
    var currentWord = ""
    var tryIndex = 0
    var inPlay = false
    ...
    func newGame(){
        ...
        coorectlyPlacedLetters = [String](repeating: "-", count: 5)
        currentWord = ""
        inPlay = true
        tryIndex = 0
        gameOver = false
    ...
    func hardCorrectCheck() -> String?{
        let guessLetters = guesses[tryIndex].guessLetter
        for i in 0...4{
            if coorectlyPlacedLetters[i] != "-"{
                if guessLetters[i] != coorectlyPlacedLetters[i]{
                    let formatter = NumberFormatter()
                    formatter.numberStyle = .ordinal
                    return "\(formatter.string(for: i + 1)!) Letter Must be there '\(coorectlyPlacedLetters[i])'"
                }
            }
        }
    ...
    func setCurrentGuessColors(){
        ...
        for index in 0...4 {
            ...
            if correctLetter == guessLetter{
                ...
                coorectlyPlacedLetters[index] = correctLetter
